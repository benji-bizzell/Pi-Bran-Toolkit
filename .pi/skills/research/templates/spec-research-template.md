...
| Dependency | Category | Public/Internal | Notes |
|------------|----------|-----------------|-------|
| `{module}` | {in-process / local-substitutable / ports & adapters / mock} | {public / internal} | {notes} |
...
{What this spec exposes for other modules to import. Only list items that MUST be accessible from outside.}

- `{type/function}` — {purpose}

### Internal Implementation

{What stays hidden behind the barrel. Other modules must NOT import these directly.}

- `{type/function}` — {why internal}
